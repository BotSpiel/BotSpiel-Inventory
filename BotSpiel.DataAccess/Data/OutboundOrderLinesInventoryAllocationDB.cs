...
namespace BotSpiel.DataAccess.Data
{
    ...
    public class OutboundOrderLinesInventoryAllocationDB : DbContext
    {

        public OutboundOrderLinesInventoryAllocationDB(DbContextOptions<OutboundOrderLinesInventoryAllocationDB> options)
            : base(options)
        {
        }
...
*/
		...
		public DbSet<OutboundOrderLinesInventoryAllocation> OutboundOrderLinesInventoryAllocation { get; set; }
		public DbSet<OutboundOrderLinesInventoryAllocationPost> OutboundOrderLinesInventoryAllocationPost { get; set; }
        ...
        {
            modelBuilder.Entity<OutboundOrderLinesInventoryAllocation>()
                .ToTable("tx_vw_OutboundOrderLinesInventoryAllocation")
                .HasKey(c => new { c.ixOutboundOrderLineInventoryAllocation });
            modelBuilder.Entity<OutboundOrderLinesInventoryAllocationPost>()
                .ToTable("tx_vw_OutboundOrderLinesInventoryAllocationPost")
                .HasKey(c => new { c.ixOutboundOrderLineInventoryAllocation });
        ...
        {
            var changes = 0;
            foreach (var e in ChangeTracker.Entries().Where(e => (e.State != EntityState.Unchanged) && (e.State != EntityState.Detached) && (e.Entity is OutboundOrderLinesInventoryAllocationPost)).ToList())
            {
                var tx_vw_outboundorderlinesinventoryallocationpost = e.Entity as OutboundOrderLinesInventoryAllocationPost;
                switch (e.State)
                {
                    case EntityState.Added:
                        ...
                        using (var cmd = con.CreateCommand())
                        {
                            ...
                            ixOutboundOrderLine.Value = tx_vw_outboundorderlinesinventoryallocationpost.ixOutboundOrderLine;
                            var nBaseUnitQuantityAllocated = cmd.CreateParameter();
                            nBaseUnitQuantityAllocated.ParameterName = "p1";
                            nBaseUnitQuantityAllocated.Value = tx_vw_outboundorderlinesinventoryallocationpost.nBaseUnitQuantityAllocated;
                            var nBaseUnitQuantityPicked = cmd.CreateParameter();
                            nBaseUnitQuantityPicked.ParameterName = "p2";
                            nBaseUnitQuantityPicked.Value = tx_vw_outboundorderlinesinventoryallocationpost.nBaseUnitQuantityPicked;
                            var ixStatus = cmd.CreateParameter();
                            ixStatus.ParameterName = "p3";
                            ixStatus.Value = tx_vw_outboundorderlinesinventoryallocationpost.ixStatus;
                            var UserName = cmd.CreateParameter();
                            UserName.ParameterName = "p4";
                            UserName.Value = tx_vw_outboundorderlinesinventoryallocationpost.UserName;

                            var ixOutboundOrderLineInventoryAllocation = cmd.CreateParameter();
                            ixOutboundOrderLineInventoryAllocation.ParameterName = "p5";
                            ixOutboundOrderLineInventoryAllocation.DbType = DbType.Int64;
                            ixOutboundOrderLineInventoryAllocation.Direction = ParameterDirection.Output;

                            var sql = new StringBuilder();
                            sql.Append(@"exec dbo.tx_sp_CreateOutboundOrderLinesInventoryAllocation ");
                            sql.Append("@ixOutboundOrderLine = @p0, ");
                            sql.Append("@nBaseUnitQuantityAllocated = @p1, ");
                            sql.Append("@nBaseUnitQuantityPicked = @p2, ");
                            sql.Append("@ixStatus = @p3, ");
                            if (tx_vw_outboundorderlinesinventoryallocationpost.UserName != null) { sql.Append("@UserName = @p4, "); }  
                            sql.Append("@ixOutboundOrderLineInventoryAllocation = @p5 output "); 
                            cmd.CommandText = sql.ToString();

                            cmd.Parameters.Add(ixOutboundOrderLine);
                            cmd.Parameters.Add(nBaseUnitQuantityAllocated);
                            cmd.Parameters.Add(nBaseUnitQuantityPicked);
                            cmd.Parameters.Add(ixStatus);
                            if (tx_vw_outboundorderlinesinventoryallocationpost.UserName != null) { cmd.Parameters.Add(UserName); }

                            cmd.Parameters.Add(ixOutboundOrderLineInventoryAllocation); 
                            cmd.ExecuteNonQuery();
                            tx_vw_outboundorderlinesinventoryallocationpost.ixOutboundOrderLineInventoryAllocation = (Int64)ixOutboundOrderLineInventoryAllocation.Value;
                            con.Close();
                        }
						e.GetInfrastructure().MarkAsTemporary(e.Metadata.FindProperty("ixOutboundOrderLineInventoryAllocation"), false);
						e.State = EntityState.Detached;
                        break;

                    case EntityState.Modified:
                        Database.ExecuteSqlCommand("exec dbo.tx_sp_ChangeOutboundOrderLinesInventoryAllocation @ixOutboundOrderLineInventoryAllocation = @p0, @ixOutboundOrderLine = @p1, @nBaseUnitQuantityAllocated = @p2, @nBaseUnitQuantityPicked = @p3, @ixStatus = @p4, @UserName = @p5", tx_vw_outboundorderlinesinventoryallocationpost.ixOutboundOrderLineInventoryAllocation, tx_vw_outboundorderlinesinventoryallocationpost.ixOutboundOrderLine, tx_vw_outboundorderlinesinventoryallocationpost.nBaseUnitQuantityAllocated, tx_vw_outboundorderlinesinventoryallocationpost.nBaseUnitQuantityPicked, tx_vw_outboundorderlinesinventoryallocationpost.ixStatus, tx_vw_outboundorderlinesinventoryallocationpost.UserName);
                        e.State = EntityState.Detached;                            
						break;

                    case EntityState.Deleted:
                        Database.ExecuteSqlCommand("exec dbo.tx_sp_DeleteOutboundOrderLinesInventoryAllocation @ixOutboundOrderLineInventoryAllocation = @p0, @ixOutboundOrderLine = @p1, @nBaseUnitQuantityAllocated = @p2, @nBaseUnitQuantityPicked = @p3, @ixStatus = @p4, @UserName = @p5", tx_vw_outboundorderlinesinventoryallocationpost.ixOutboundOrderLineInventoryAllocation, tx_vw_outboundorderlinesinventoryallocationpost.ixOutboundOrderLine, tx_vw_outboundorderlinesinventoryallocationpost.nBaseUnitQuantityAllocated, tx_vw_outboundorderlinesinventoryallocationpost.nBaseUnitQuantityPicked, tx_vw_outboundorderlinesinventoryallocationpost.ixStatus, tx_vw_outboundorderlinesinventoryallocationpost.UserName);
                        e.State = EntityState.Detached;                           
						break;
                }
