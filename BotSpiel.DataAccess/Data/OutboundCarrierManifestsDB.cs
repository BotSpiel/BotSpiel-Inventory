...
*/
        ...
        {
            var changes = 0;
            foreach (var e in ChangeTracker.Entries().Where(e => (e.State != EntityState.Unchanged) && (e.State != EntityState.Detached) && (e.Entity is OutboundCarrierManifestsPost)).ToList())
            {
                ...
                switch (e.State)
                {
                    case EntityState.Added:
                        ...
                        using (var cmd = con.CreateCommand())
                        {
                            ...
                            ixFacility.Value = tx_vw_outboundcarriermanifestspost.ixFacility;
                            ...
                            ixPickupInventoryLocation.ParameterName = "p2";
                            ...
                            dtScheduledPickupAt.ParameterName = "p3";
                            ...
                            if (tx_vw_outboundcarriermanifestspost.ixPickupInventoryLocation != null) { sql.Append("@ixPickupInventoryLocation = @p2, "); }  
                            if (tx_vw_outboundcarriermanifestspost.dtScheduledPickupAt != null) { sql.Append("@dtScheduledPickupAt = @p3, "); }  
                            sql.Append("@ixStatus = @p4, ");
                            if (tx_vw_outboundcarriermanifestspost.UserName != null) { sql.Append("@UserName = @p5, "); }  
                            sql.Append("@ixOutboundCarrierManifest = @p6 output "); 
                    ...
                    case EntityState.Modified:
                        Database.ExecuteSqlCommand("exec dbo.tx_sp_ChangeOutboundCarrierManifests @ixOutboundCarrierManifest = @p0, @ixFacility = @p1, @ixCarrier = @p2, @ixPickupInventoryLocation = @p3, @dtScheduledPickupAt = @p4, @ixStatus = @p5, @UserName = @p6", tx_vw_outboundcarriermanifestspost.ixOutboundCarrierManifest, tx_vw_outboundcarriermanifestspost.ixFacility, tx_vw_outboundcarriermanifestspost.ixCarrier, tx_vw_outboundcarriermanifestspost.ixPickupInventoryLocation, tx_vw_outboundcarriermanifestspost.dtScheduledPickupAt, tx_vw_outboundcarriermanifestspost.ixStatus, tx_vw_outboundcarriermanifestspost.UserName);
                        e.State = EntityState.Detached;                            
						break;

                    case EntityState.Deleted:
                        Database.ExecuteSqlCommand("exec dbo.tx_sp_DeleteOutboundCarrierManifests @ixOutboundCarrierManifest = @p0, @ixFacility = @p1, @ixCarrier = @p2, @ixPickupInventoryLocation = @p3, @dtScheduledPickupAt = @p4, @ixStatus = @p5, @UserName = @p6", tx_vw_outboundcarriermanifestspost.ixOutboundCarrierManifest, tx_vw_outboundcarriermanifestspost.ixFacility, tx_vw_outboundcarriermanifestspost.ixCarrier, tx_vw_outboundcarriermanifestspost.ixPickupInventoryLocation, tx_vw_outboundcarriermanifestspost.dtScheduledPickupAt, tx_vw_outboundcarriermanifestspost.ixStatus, tx_vw_outboundcarriermanifestspost.UserName);
                        e.State = EntityState.Detached;                           
						break;
                }
